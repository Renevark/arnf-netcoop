...
**Version 1.0.1** · BepInEx plugin · 2 players

## Download

Grab the latest **`ARNFNetCoop-1.0.1.zip`** from the
...
- **Mod didn't load:** open `…\A Robot Named Fight\BepInEx\LogOutput.log` and look for
  `ARNF NetCoop v1.0.1 loaded; patches applied: N ok, 0 failed.` If that line is missing,
